...
#include "reference_trajectory/input/reference_input_producer.h"
#include "reference_trajectory/output/reference_output_consumer.h"
...
class ReferenceTrajectoryNode {
   ...
   private:
    ...
    std::string analytic_topic_{"alg/reference_trajectory/request/analytic"};
    std::string waypoint_topic_{"alg/reference_trajectory/request/waypoint"};
    std::string sampled_topic_{"alg/reference_trajectory/request/sampled"};
    std::string reset_topic_{"alg/reference_trajectory/reset"};
    std::string status_topic_{"alg/reference_trajectory/status"};
    std::string active_analytic_topic_{"alg/reference_trajectory/active/analytic"};
    std::string active_polynomial_topic_{"alg/reference_trajectory/active/polynomial"};
    std::string active_sampled_topic_{"alg/reference_trajectory/active/sampled"};
