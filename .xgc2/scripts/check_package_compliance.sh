...
grep -q "ros-noetic-xgc2-multirotor-controller (>= 1.0.10-1)" .xgc2/product.yml
...
grep -q "ros-\${ROS_DISTRO}-xgc2-multirotor-controller (>= 1.0.10-1)" .xgc2/scripts/package_debs.sh
