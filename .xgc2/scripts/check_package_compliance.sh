...
grep -q "ros-noetic-xgc2-multirotor-controller (>= 1.1.17-1)" .xgc2/product.yml
grep -q "ros-noetic-xgc2-ugv-controller (>= 1.1.3-1)" .xgc2/product.yml
...
grep -q "ros-\${ROS_DISTRO}-xgc2-multirotor-controller (>= 1.1.17-1)" .xgc2/scripts/package_debs.sh
grep -q "ros-\${ROS_DISTRO}-xgc2-ugv-controller (>= 1.1.3-1)" .xgc2/scripts/package_debs.sh
