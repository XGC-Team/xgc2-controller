...
grep -q "ros-noetic-xgc2-multirotor-controller (>= 1.1.15-8)" .xgc2/product.yml
...
grep -q "ros-\${ROS_DISTRO}-xgc2-multirotor-controller (>= 1.1.15-8)" .xgc2/scripts/package_debs.sh
