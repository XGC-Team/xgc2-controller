...
grep -q "ros-\${ROS_DISTRO}-xgc2-multirotor-controller (>= 1.1.18-4)" .xgc2/scripts/package_debs.sh
grep -q "ros-\${ROS_DISTRO}-xgc2-ugv-controller (>= 1.1.4-9)" .xgc2/scripts/package_debs.sh
