...
DroneRosNode::DroneRosNode(ros::NodeHandle& nh)
    ...
    ROS_INFO("  - alg/reference_trajectory/active/analytic");
    ROS_INFO("  - alg/reference_trajectory/active/polynomial");
    ROS_INFO("  - alg/reference_trajectory/active/sampled");
    ...
    ROS_INFO("  - alg/reference_trajectory/request/analytic");
}
