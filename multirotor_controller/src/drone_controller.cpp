...
#include "multirotor_controller/common/state_machine_queries.h"
#include "multirotor_controller/uav/state_machine/custom1_state.h"
#include "multirotor_controller/uav/state_machine/debug_monitor_state.h"
#include "multirotor_controller/uav/state_machine/health_monitor_state.h"
#include "multirotor_controller/uav/state_machine/hover_state.h"
#include "multirotor_controller/uav/state_machine/landing_state.h"
#include "multirotor_controller/uav/state_machine/ready_state.h"
#include "multirotor_controller/uav/state_machine/self_check_state.h"
#include "multirotor_controller/uav/state_machine/takeoff_arm_request_state.h"
#include "multirotor_controller/uav/state_machine/takeoff_ascending_state.h"
...
DroneController::DroneController(const SensorData &sensor_data)
  ...
  builder.region(region_type::HEALTH)
      ...
      .when([this](const ::state_machine::GuardContext &) {
        return state_machine_ &&
               state_machine_queries::isActiveStateTimeout(
...
void DroneController::log(LogLevel level, const char *format,
