...
public:
  MpcTrajectoryState &active() { return active_; }
  const MpcTrajectoryState &active() const { return active_; }

  bool hasPending() const { return pending_.is_valid; }
  const MpcTrajectoryState &pending() const { return pending_; }
