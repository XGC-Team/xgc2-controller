...
class TrajectoryInputProducer {
   ...
   private:
    ...
    void activeAnalyticCallback(const reference_trajectory::AnalyticReference::ConstPtr& msg);
    void activePolynomialCallback(
        const reference_trajectory::ActivePolynomialReference::ConstPtr& msg);
    void activeSampledCallback(const reference_trajectory::SampledReference::ConstPtr& msg);
