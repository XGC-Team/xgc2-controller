...
private:
  ...
  static std_msgs::Float32MultiArray
  makeTopicStatsMessage(const SensorData::TopicStats &stats);
  static std_msgs::Float32MultiArray
  makeVrpnQualityMessage(const ros1_utils::PositionQualityStats &stats);
